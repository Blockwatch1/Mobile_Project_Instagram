...
class RepliesPage extends StatefulWidget {
  ...
  String comment;
  User user;
  RepliesPage({super.key,required this.commentId,required this.user,required this.comment, required PostModel post}): _post=post ;
    ...
    return Container(
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          bottomNavigationBar:  BottomCommentTextField(commentController: _replyController, post: widget._post,),
        ),
      ),
    );
  }
